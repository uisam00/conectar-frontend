  ...
  useEffect(() => {
    const confirmNewEmail = async () => {
      ...
      try {
        ...
        setStatus("success");
        setMessage(t("emailConfirmation.newEmailSuccessMessage"));
      } catch (error: any) {
        setStatus("error");
        setMessage(
          error.response?.data?.message ||
            t("emailConfirmation.newEmailErrorMessage")
        );
      }
    };
        ...
        return (
          ...
          >
            ...
            <Typography variant="h6" color="text.secondary">
              {t("emailConfirmation.newEmailLoading")}
            </Typography>
          </Box>
        );
        ...
        return (
          ...
          >
            ...
            <Typography variant="h5" color="success.main" textAlign="center">
              {t("emailConfirmation.newEmailSuccess")}
            </Typography>
